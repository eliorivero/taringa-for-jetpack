...
class Taringa extends Server
{
    ...
    {
        return 'https://api.taringa.net/oauth/request_token';
    }
    ...
    {
        return 'https://api.taringa.net/oauth/authorize';
    }
    ...
    {
        return 'https://api.taringa.net/oauth/access_token';
    }
